...
const { uploadBook, validatePdfMagic } = require("../middleware/upload.middleware");
 ...
 */
router.post("/", auth, adminOnly, uploadBook.single("file"), validatePdfMagic, createBookRules, validate, c.create);
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.put("/:id", auth, adminOnly, uploadBook.single("file"), validatePdfMagic, updateBookRules, validate, c.update);
