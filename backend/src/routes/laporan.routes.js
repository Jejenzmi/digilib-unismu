...
const { auth, adminOnly, adminOrFakultasAdmin } = require("../middleware/auth.middleware");
 ...
 */
router.get("/statistik", auth, adminOrFakultasAdmin, c.statistik);
 ...
 */
router.get("/peminjaman-per-bulan", auth, adminOrFakultasAdmin, c.peminjamanPerBulan);
